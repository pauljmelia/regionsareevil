// -----------------------------------------------------------------------
// <copyright file="ClassificationFormatDefinition.cs" company="Equilogic (Pty) Ltd">
    ...
    internal abstract class ClassificationFormatDefinition : EditorFormatDefinition
    {
        ...
        protected override ResourceDictionary CreateResourceDictionaryFromDefinition()
        {
            ...
            if (ForegroundBrush != null)
            {
                ...
                if (Math.Abs(ForegroundBrush.Opacity - 1.0) > 0)
                {
            ...
            if (BackgroundBrush != null)
            {
                ...
                if (Math.Abs(BackgroundBrush.Opacity - 1.0) > 0)
                {
